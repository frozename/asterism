...
// 69 of 148 tracked files are type-checked by tsconfig.json today; the other
// 79 are named below with the tsc error that keeps each one out -- either its
...
export const TYPE_COVERAGE_LEDGER = Object.freeze([
  ...
  Object.freeze({ file: 'src/cli/verbs/init.js', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  ...
  Object.freeze({ file: 'src/hook/index.js', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
