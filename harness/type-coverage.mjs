...
export const TYPE_COVERAGE_LEDGER = Object.freeze([
  ...
  Object.freeze({ file: 'src/adapters/claude/discover.js', reason: 'does not type-check: src/adapters/claude/discover.js(13,34): error TS2345: Argument of type \'string\' is not assignable to parameter of type \'"bridgeSessionId" | "cwd" | "entrypoint" | "kind" | "messagingSocketPath" | "name" | "nameSince" | "nameSource" | "peerFeatures" | "peerProtocol" | "pid" | "procStart" | "sessionId" | ... 6 more ... | "waitingFor"\'.' }), // quarantine-exempt
  Object.freeze({ file: 'src/adapters/claude/index.js', reason: 'transitively imports src/adapters/claude/discover.js, which does not type-check: src/adapters/claude/discover.js(13,34): error TS2345: Argument of type \'string\' is not assignable to parameter of type \'"bridgeSessionId" | "cwd" | "entrypoint" | "kind" | "messagingSocketPath" | "name" | "nameSince" | "nameSource" | "peerFeatures" | "peerProtocol" | "pid" | "procStart" | "sessionId" | ... 6 more ... | "waitingFor"\'.' }), // quarantine-exempt
  Object.freeze({ file: 'src/adapters/index.js', reason: 'does not type-check: src/adapters/index.js(12,18): error TS2345: Argument of type \'"fake"\' is not assignable to parameter of type \'"claude"\'.' }), // quarantine-exempt
  ...
  Object.freeze({ file: 'src/capture/tmux.js', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  Object.freeze({ file: 'src/cli/pipeline.js', reason: 'does not type-check: src/cli/pipeline.js(7,10): error TS6133: \'buildIndexPayload\' is declared but its value is never read.' }),
  Object.freeze({ file: 'src/cli/verbs/archive.js', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  Object.freeze({ file: 'src/cli/verbs/bind.js', reason: 'does not type-check: src/cli/verbs/bind.js(41,45): error TS2739: Type \'{ env: any; adapters: any; home: string; store: Readonly<{ stateDir: string; configDir: string; writeSession(ulid: any, record: any): Promise<void>; archiveSession(ulid: any, record: any, { beforeRemove }?: {}): Promise<...>; ... 9 more ...; ensureConfig(): Promise<...>; }>; }\' is missing the following properties from type \'{ adapters: any; env: any; execute: any; home: any; mint: any; now?: number; store: any; }\': execute, mint' }),
  Object.freeze({ file: 'src/cli/verbs/doctor.js', reason: 'does not type-check: src/cli/verbs/doctor.js(42,45): error TS2741: Property \'registry\' is missing in type \'{ root: any; home: string; env: { PATH: any; HOME: string; TERM: any; LANG: any; XDG_STATE_HOME?: any; XDG_CONFIG_HOME?: any; }; }\' but required in type \'{ checks?: readonly (Readonly<{ id: "state.permissions"; prevents: "a state file that other users on the machine can read."; run: (ctx: any) => Promise<any>; }> | Readonly<{ id: "state.targets-are-ids"; prevents: "state that persists a pane or session target keyed by a mutable name instead of a stable id."; run: (ct...\'.' }),
  Object.freeze({ file: 'src/cli/verbs/fixture.js', reason: 'transitively imports src/capture/run.js, which does not type-check: src/capture/run.js(14,40): error TS2345: Argument of type \'Readonly<{ cell: "claude/help"; provoke: "none"; source: "argv"; argv: readonly string[]; cliVersionArgv: readonly string[]; }> | Readonly<{ cell: "claude/agents-json/idle"; provoke: "at least one session in the idle state"; source: "argv"; argv: readonly string[]; cliVersionArgv: readonly string[]; }> | ... 13 more...\' is not assignable to parameter of type \'Readonly<{ cell: string; provoke: "none"; source: "tmux"; cliVersionArgv: readonly string[]; run: (context: any) => Promise<{ version?: undefined; ok: boolean; message: string; text?: undefined; command?: undefined; } | { ...; }>; }>\'.' }), // quarantine-exempt
  Object.freeze({ file: 'src/cli/verbs/go.js', reason: 'does not type-check: src/cli/verbs/go.js(96,40): error TS2741: Property \'clientName\' is missing in type \'{ target: any; socketPath: any; env: any; }\' but required in type \'{ [x: string]: any; clientName: any; target: any; }\'.' }),
  Object.freeze({ file: 'src/cli/verbs/init.js', reason: 'transitively imports src/io/tmuxexec.js, which does not type-check: src/io/tmuxexec.js(55,35): error TS2339: Property \'cwd\' does not exist on type \'{ command?: undefined[]; detached?: boolean; }\'.' }),
  Object.freeze({ file: 'src/cli/verbs/ls.js', reason: 'does not type-check: src/cli/verbs/ls.js(70,62): error TS2739: Type \'{ env: any; adapters: any; home: string; store: Readonly<{ stateDir: string; configDir: string; writeSession(ulid: any, record: any): Promise<void>; archiveSession(ulid: any, record: any, { beforeRemove }?: {}): Promise<...>; ... 9 more ...; ensureConfig(): Promise<...>; }>; }\' is missing the following properties from type \'{ adapters: any; env: any; execute: any; home: any; mint: any; now?: number; store: any; }\': execute, mint' }),
  Object.freeze({ file: 'src/cli/verbs/name.js', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  ...
  Object.freeze({ file: 'src/core/liveness.js', reason: 'does not type-check: src/core/liveness.js(8,35): error TS2339: Property \'utc\' does not exist on type \'{}\'.' }),
  ...
  Object.freeze({ file: 'src/core/tmuxparse.js', reason: 'does not type-check: src/core/tmuxparse.js(7,40): error TS2339: Property \'paneCount\' does not exist on type \'{}\'.' }),
  Object.freeze({ file: 'src/doctor/index.js', reason: 'transitively imports src/io/tmuxexec.js, which does not type-check: src/io/tmuxexec.js(55,35): error TS2339: Property \'cwd\' does not exist on type \'{ command?: undefined[]; detached?: boolean; }\'.' }),
  Object.freeze({ file: 'src/hook/events/notification.js', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  Object.freeze({ file: 'src/hook/index.js', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  Object.freeze({ file: 'src/io/discover.js', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  Object.freeze({ file: 'src/io/identity.js', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  Object.freeze({ file: 'src/io/notify.js', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  Object.freeze({ file: 'src/io/procexec.js', reason: 'does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  Object.freeze({ file: 'src/io/procs.js', reason: 'does not type-check: src/io/procs.js(27,64): error TS2339: Property \'env\' does not exist on type \'{ execute?: (argv: any, options?: {}) => Promise<any>; }\'.' }),
  Object.freeze({ file: 'src/io/store.js', reason: 'does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  Object.freeze({ file: 'src/io/tmuxexec.js', reason: 'does not type-check: src/io/tmuxexec.js(55,35): error TS2339: Property \'cwd\' does not exist on type \'{ command?: undefined[]; detached?: boolean; }\'.' }),
  ...
  Object.freeze({ file: 'test/adapter-registry.test.mjs', reason: 'transitively imports src/adapters/index.js, which does not type-check: src/adapters/index.js(12,18): error TS2345: Argument of type \'"fake"\' is not assignable to parameter of type \'"claude"\'.' }), // quarantine-exempt
  Object.freeze({ file: 'test/archive.test.mjs', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  ...
  Object.freeze({ file: 'test/capability-ledger.test.mjs', reason: 'transitively imports src/adapters/index.js, which does not type-check: src/adapters/index.js(12,18): error TS2345: Argument of type \'"fake"\' is not assignable to parameter of type \'"claude"\'.' }), // quarantine-exempt
  Object.freeze({ file: 'test/cli.test.mjs', reason: 'transitively imports src/adapters/index.js, which does not type-check: src/adapters/index.js(12,18): error TS2345: Argument of type \'"fake"\' is not assignable to parameter of type \'"claude"\'.' }), // quarantine-exempt
  ...
  Object.freeze({ file: 'test/identity.test.mjs', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  Object.freeze({ file: 'test/init-uninstall.test.mjs', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  Object.freeze({ file: 'test/lint.test.mjs', reason: 'transitively imports harness/lint/source.mjs, which does not type-check: harness/lint/source.mjs(116,21): error TS2739: Type \'{ type: string; }\' is missing the following properties from type \'{ type: string; templateExpression: boolean; braceDepth: number; }\': templateExpression, braceDepth' }),
  Object.freeze({ file: 'test/liveness.test.mjs', reason: 'transitively imports src/core/liveness.js, which does not type-check: src/core/liveness.js(8,35): error TS2339: Property \'utc\' does not exist on type \'{}\'.' }),
  ...
  Object.freeze({ file: 'test/manifest-captures.test.mjs', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  Object.freeze({ file: 'test/manifest.test.mjs', reason: 'transitively imports src/adapters/index.js, which does not type-check: src/adapters/index.js(12,18): error TS2345: Argument of type \'"fake"\' is not assignable to parameter of type \'"claude"\'.' }), // quarantine-exempt
  ...
  Object.freeze({ file: 'test/new.test.mjs', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  ...
  Object.freeze({ file: 'test/park.test.mjs', reason: 'transitively imports src/io/store.js, which does not type-check: src/io/store.js(74,74): error TS2339: Property \'beforeRename\' does not exist on type \'{ mode?: number; }\'.' }),
  Object.freeze({ file: 'test/pipeline.test.mjs', reason: 'does not type-check: test/pipeline.test.mjs(42,39): error TS2739: Type \'{ tmp: string; root: string; env: { ASTERISM_FAKE_ROOT: string; HOME: string; XDG_STATE_HOME: string; }; store: Readonly<{ stateDir: string; configDir: string; writeSession(ulid: any, record: any): Promise<...>; ... 10 more ...; ensureConfig(): Promise<...>; }>; adapters: Map<...>; }\' is missing the following properties from type \'{ adapters: any; env: any; execute: any; home: any; mint: any; now?: number; store: any; }\': execute, home, mint' }),
  ...
  Object.freeze({ file: 'test/procexec.test.mjs', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  Object.freeze({ file: 'test/procs.test.mjs', reason: 'does not type-check: test/procs.test.mjs(25,60): error TS2353: Object literal may only specify known properties, and \'env\' does not exist in type \'{ execute?: (argv: any, options?: {}) => Promise<any>; }\'.' }),
  ...
  Object.freeze({ file: 'test/tmuxexec.test.mjs', reason: 'does not type-check: test/tmuxexec.test.mjs(105,45): error TS2741: Property \'clientName\' is missing in type \'{ socketPath: string; env: { PATH: string; HOME: string; }; execute: (argv: any) => Promise<{ code: number; stdout: Buffer<ArrayBuffer>; stderr: Buffer<ArrayBuffer>; }>; target: string; }\' but required in type \'{ [x: string]: any; clientName: any; target: any; }\'.' }),
  Object.freeze({ file: 'test/tmuxparse.test.mjs', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
  ...
  Object.freeze({ file: 'test/width-parity-l3.test.mjs', reason: 'transitively imports src/io/procexec.js, which does not type-check: src/io/procexec.js(18,48): error TS2769: No overload matches this call.' }),
