...
// 57 of 148 tracked files are type-checked by tsconfig.json today; the other
// 91 are named below with the tsc error that keeps each one out -- either its
...
export const TYPE_COVERAGE_LEDGER = Object.freeze([
  ...
  Object.freeze({ file: 'src/cli/pipeline.js', reason: 'does not type-check: src/cli/pipeline.js(133,53): error TS2559: Type \'{ env: any; }\' has no properties in common with type \'{ execute?: (argv: any, options?: {}) => Promise<any>; }\'.' }),
  ...
  Object.freeze({ file: 'src/cli/verbs/go.js', reason: 'does not type-check: src/cli/verbs/go.js(126,52): error TS2739: Type \'{ env: any; adapters: any; home: string; store: Readonly<{ stateDir: string; configDir: string; writeSession(ulid: any, record: any): Promise<void>; archiveSession(ulid: any, record: any, { beforeRemove }?: {}): Promise<...>; ... 10 more ...; ensureConfig(): Promise<...>; }>; }\' is missing the following properties from type \'{ adapters: any; env: any; execute: any; home: any; mint: any; now?: number; persist?: boolean; store: any; }\': execute, mint' }),
  ...
  Object.freeze({ file: 'test/adapter-registry.test.mjs', reason: 'transitively imports src/adapters/claude/discover.js, which does not type-check: src/adapters/claude/discover.js(13,34): error TS2345: Argument of type \'string\' is not assignable to parameter of type \'"bridgeSessionId" | "cwd" | "entrypoint" | "kind" | "messagingSocketPath" | "name" | "nameSince" | "nameSource" | "peerFeatures" | "peerProtocol" | "pid" | "procStart" | "sessionId" | ... 6 more ... | "waitingFor"\'.' }), // quarantine-exempt
  ...
  Object.freeze({ file: 'test/capability-ledger.test.mjs', reason: 'transitively imports src/adapters/claude/discover.js, which does not type-check: src/adapters/claude/discover.js(13,34): error TS2345: Argument of type \'string\' is not assignable to parameter of type \'"bridgeSessionId" | "cwd" | "entrypoint" | "kind" | "messagingSocketPath" | "name" | "nameSince" | "nameSource" | "peerFeatures" | "peerProtocol" | "pid" | "procStart" | "sessionId" | ... 6 more ... | "waitingFor"\'.' }), // quarantine-exempt
  Object.freeze({ file: 'test/cli.test.mjs', reason: 'transitively imports src/adapters/claude/discover.js, which does not type-check: src/adapters/claude/discover.js(13,34): error TS2345: Argument of type \'string\' is not assignable to parameter of type \'"bridgeSessionId" | "cwd" | "entrypoint" | "kind" | "messagingSocketPath" | "name" | "nameSince" | "nameSource" | "peerFeatures" | "peerProtocol" | "pid" | "procStart" | "sessionId" | ... 6 more ... | "waitingFor"\'.' }), // quarantine-exempt
  ...
  Object.freeze({ file: 'test/manifest.test.mjs', reason: 'transitively imports src/adapters/claude/discover.js, which does not type-check: src/adapters/claude/discover.js(13,34): error TS2345: Argument of type \'string\' is not assignable to parameter of type \'"bridgeSessionId" | "cwd" | "entrypoint" | "kind" | "messagingSocketPath" | "name" | "nameSince" | "nameSource" | "peerFeatures" | "peerProtocol" | "pid" | "procStart" | "sessionId" | ... 6 more ... | "waitingFor"\'.' }), // quarantine-exempt
  ...
  Object.freeze({ file: 'test/refuse-rules.test.mjs', reason: 'transitively imports src/adapters/claude/discover.js, which does not type-check: src/adapters/claude/discover.js(13,34): error TS2345: Argument of type \'string\' is not assignable to parameter of type \'"bridgeSessionId" | "cwd" | "entrypoint" | "kind" | "messagingSocketPath" | "name" | "nameSince" | "nameSource" | "peerFeatures" | "peerProtocol" | "pid" | "procStart" | "sessionId" | ... 6 more ... | "waitingFor"\'.' }), // quarantine-exempt
